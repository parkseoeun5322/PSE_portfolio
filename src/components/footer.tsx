        ...
        <footer className="footer">
            <div className="footer__icons">
                ...
                <div className="footer__icon-wrapper" title="Tistory">
                    <a href="https://mystudyblog-it.tistory.com" target="_blank"><img src={import.meta.env.VITE_IMAGE_URL_FRONT + 'footer/logo_tistory.png' + import.meta.env.VITE_IMAGE_URL_BACK} alt="" /></a>
                </div>
            </div>
